...
const canProceed = () => {
  switch (step) {
    ...
    case 2:
      return isHandyman ? (formData.phone.length > 0 && formData.bio.length > 0) : formData.phone.length > 0;
    case 3:
      return formData.services.length >= 2;
    case 4:
      return formData.hourlyRate.length > 0;
    default:
      return false;
  }
};
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-orange-100">
          ...
          <div className="flex justify-between mt-8">
           ...
           <Button
            ...
            >
            {loading ? 'Saving...' : (step === (isHandyman ? 4 : 2) ? 'Complete Setup' : 'Continue')}
            </Button>
          </div>
        </div>
      </motion.div>
...
function LocationStep({ formData, onChange, isHandyman }: OnboardingStepProps) {
  const neighborhoods = [
    'Highland Park', 'Glassell Park', 'Eagle Rock', 'Mt Washington',
    'Silver Lake', 'Echo Park', 'Los Feliz', 'Atwater Village'
  ];
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-slate-600">
          {isHandyman ? 'Select neighborhoods you serve' : 'Choose your neighborhood to find local help'}
        </p>
      </div>
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-slate-600">Just need your phone number for booking confirmations</p>
      </div>
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-bold text-slate-800 mb-2">Tell your story</h2>
...
function ServicesStep({ formData, onChange }: OnboardingStepProps) {
  const services = [
    ...
    'Appliance Repair', 'Furniture Assembly', 'Home Cleaning',
    'Landscaping', 'Tile Work', 'Drywall Repair'
  ];
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-bold text-slate-800 mb-2">What do you do?</h2>
        <p className="text-slate-600">Select all services you offer (pick at least 2)</p>
      </div>
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-bold text-slate-800 mb-2">Set your rate</h2>
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="50"
            />
            <span className="absolute right-4 top-1/2 transform -translate-y-1/2 text-slate-500">/hour</span>
          </div>
        ...
        <div className="bg-orange-50 p-6 rounded-2xl border border-orange-200">
          <h3 className="font-semibold text-slate-800 mb-2">You&apos;re almost ready!</h3>
          <p className="text-slate-600 text-sm">
            After completing setup, you&apos;ll be visible to neighbors in {formData.neighborhood}. 
            Start getting requests within 24 hours!
          </p>
        </div>
      </div>
    </motion.div>
