        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center h-full">
            ...
            <div>
              ...
              >
                Need something
                <span className="block text-orange-600">fixed around here?</span>
              </motion.h1>
              ...
              >
                Connect with trusted neighbors who know their stuff. Real local folks doing honest work.
              </motion.p>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="md:text-3xl text-2xl font-bold text-slate-900">Only 2%</div>
              </motion.div>
              ...
              >
                ...
                <div className="md:text-3xl text-2xl font-bold text-slate-900">Under 24hr</div>
              </motion.div>
              ...
              >
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <span className="text-slate-600 font-medium">Local Focus</span>
                </div>
                <div className="md:text-3xl text-2xl  font-bold text-slate-900">100% Neighbors</div>
              </motion.div>
            </div>
          </div>
        </div>
