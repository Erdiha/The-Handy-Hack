      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex items-center space-x-1">
           <Link 
  href="/search" 
  className="px-4 py-2 text-slate-700 hover:text-orange-600 hover:bg-orange-50 rounded-lg transition-all duration-200 font-medium"
>
  Find Help
</Link>
           <Link href="/how-it-works" className="px-4 py-2 text-slate-700 hover:text-orange-600 hover:bg-orange-50 rounded-lg transition-all duration-200 font-medium">
  How It Works
</Link>
            <a 
              href="#" 
...
>
  Sign Out
        ...
        >
          ...
          <Link href="/search" className="block px-4 py-3 text-slate-700 hover:text-orange-600 hover:bg-orange-50 rounded-lg font-medium transition-colors duration-200">
  Find Help
</Link>
          <Link href="/how-it-works" className="block px-4 py-3 text-slate-700 hover:text-orange-600 hover:bg-orange-50 rounded-lg font-medium transition-colors duration-200">
  How It Works
</Link>
            <a href="#" className="block px-4 py-3 text-slate-700 hover:text-orange-600 hover:bg-orange-50 rounded-lg font-medium transition-colors duration-200">
              Stories
            </a>
                ...
                <>
                  <div className="flex items-center px-4 py-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-500 capitalize">{session.user.role}</div>
                    </div>
                  </div>
                  <Link 
                    href="/dashboard"
